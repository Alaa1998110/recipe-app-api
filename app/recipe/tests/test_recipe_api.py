...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_tag_on_update(self):
        ...
        #no refresh from db as it is many to many relationship
    ...
    def test_update_recipe_assign_ingredient(self):
        """test assigning ingredients when update recipe"""
    ...
    def test_clear_recipe_ingredients(self):
        """test clear ingredients from recipe"""
        ingrdient1=Ingredient.objects.create(user=self.user,name='Lemon')
        recipe=create_recipe(user=self.user)
    ...
    def test_filter_by_tags(self):
        ...
        r1=create_recipe(user=self.user,title='Lemon lollo')
        r2=create_recipe(user=self.user,title='Salt nnoo')
        tag1=Tag.objects.create(user=self.user,name='Vegan')
        tag2=Tag.objects.create(user=self.user,name='Dessert')
        r1.tags.add(tag1)
        r2.tags.add(tag2)
        r3=create_recipe(user=self.user,title='NO Matter')
